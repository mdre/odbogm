...
public class ObjectMapper {
     ...
     */
    public <T> T hydrate(Class<T> c, OrientVertex v, Transaction t) throws InstantiationException, IllegalAccessException, NoSuchFieldException, CollectionNotSupported {
        t.initInternalTx();
